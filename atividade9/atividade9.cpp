...
// compilar: g++ atividade9.cpp -o atividade9 -fsanitize=address -static-libasan -g
...
vector<int> gera_vizinho_switch_two(vector<int> solucao, int ver, int f_idx, int s_idx)
{
...
vector<int> gera_vizinho_shift_two(vector<int> solucao, int ver, int f_idx, int s_idx)
{
    vector<int> vizinho = solucao;
...
vector<int> gera_vizinho_link_two(vector<int> solucao, int ver, int f_idx, int s_idx)
{
...
solution busca_local(solution sol_inicial, int ver, float **mat, int vizinhaca)
{
